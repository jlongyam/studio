...
Options:
  legacy              Sub command "legacy"
`

const help_legacy = `
Usage: studio legacy <command> [options]
...
Commands:
  ...
  uninstall           Delete studio/legacy contents 
`
...
if (args[0] === '-h') {
  ...
  if (args[1] === 'install') {
    ...
    if (args[2]) {
      execSync(`open ${current.location}/build/${args[2]}/${args[2]}.app -W`)
    } else {
      console.clear()
      console.log(help_legacy)
    }
  }
